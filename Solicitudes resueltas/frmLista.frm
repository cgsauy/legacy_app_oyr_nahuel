...
Begin VB.Form frmLista 
   ...
   Begin VB.Menu MnuBD 
      ...
      End
      Begin VB.Menu MnuDondeRecibos 
         Caption         =   "¿Dónde imprimo recibos de cuotas?"
      End
      Begin VB.Menu MnuDondeeFactura 
         Caption         =   "¿Dónde imprimo eFactura?"
      End
...
Private Sub Form_Load()
    ...
    If Not ConectarSignalR Then
        MsgBox "No conectó el signalR, se procede a lectura por tiempo.", vbCritical, "ATENCIÓN"
        QuerySolicitudes
        Timer1.Enabled = True
    Else
...
Private Sub MnuDevolver_Click(Index As Integer)
    ...
    If Val(MnuBD.Tag) <> 0 Then
        ...
        End If
        modStart.NotificoCambioSignalR
    End If
End Sub

Private Sub MnuDondeeFactura_Click()
    Dim frmD As New frmDondeTicket
    frmD.Titulo = "Indique donde imprime los ticket de crédito?"
    Dim oCnfgRecibo As New clsImpresoraTicketsCnfg
    oCnfgRecibo.CargarConfiguracion CGSA_TickeadoraCredito, "CuotasImpresora"
    Set frmD.oCnfg = oCnfgRecibo
    frmD.Show vbModal
    oCnfgRecibo.GuardarConfiguracion CGSA_TickeadoraCredito, "CuotasImpresora"
End Sub

Private Sub MnuDondeRecibos_Click()

    Dim frmD As New frmDondeTicket
    frmD.Titulo = "Indique donde imprime los recibos de cuotas?"
    Dim oCnfgRecibo As New clsImpresoraTicketsCnfg
    oCnfgRecibo.CargarConfiguracion "ImpresionDocumentos", "TicketCuota"
    Set frmD.oCnfg = oCnfgRecibo
    frmD.Show vbModal
    oCnfgRecibo.GuardarConfiguracion "ImpresionDocumentos", "TicketCuota"

End Sub

Private Sub MnuPrintCnfgConformes_Click()

    Dim frmD As New frmDondeConformes
    frmD.Titulo = "Indique donde imprime los conformes"
    oCnfgPrint.CargarConfiguracion cnfgAppNombreConformes, cnfgKeyTicketConformes
    Set frmD.oCnfg = oCnfgPrint
    frmD.Show vbModal
    oCnfgPrint.CargarConfiguracion cnfgAppNombreConformes, cnfgKeyTicketConformes
...
Private Sub oHub_CallBack(ByVal methodName As String, ByVal info As String)
    If LCase(methodName) = LCase("CargarSolicitudesResueltas") Then
...
Private Sub QuerySolicitudes()
    ...
    If ObtenerResultSet(cBase, rsSol, Cons, "comercio") <> RAQ_SinError Then Screen.MousePointer = 0: Exit Sub
...
Private Sub Timer1_Timer()
    ...
    'Timer1.Enabled = Not ConectarSignalR
End Sub
            ...
            Case "N"        'Nuevo o Modificada     ------------------------------------------------
                    Select Case Val(arrValue(1))
                        Case Asuntos.SolicitudesResueltas
                            ...
                            If Val(arrValue(0)) = paCodigoDeSucursal Then
...
Private Function ConectarSignalR() As Boolean
    ...
    oHub.AddMethodCallBack "CargarSolicitudesResueltas"
...
'    Exit Function
    ...
    Timer1.Tag = IIf(ConectarSignalR, "conectado", "")
End Function
