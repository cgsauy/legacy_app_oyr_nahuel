VERSION 5.00
Begin VB.Form frmDondeImprimoSC 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "Seleccione donde  se imprimen las salidas de caja"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   12
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   120
         Picture         =   "frmDondeImprimoSC.frx":0000
         Top             =   120
         Width           =   480
      End
   End
   ...
   End
End
Attribute VB_Name = "frmDondeImprimoSC"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private oCnfgPrintSC As New clsCnfgImpresora
Public ImpresorapapelA5 As String
...
On Error GoTo errL
    ...
    oCnfgPrintSC.CargarConfiguracion cnfgAppNombreMovimientoCaja, cnfgKeyTicketMovimientoCaja
    
    optImpresora(oCnfgPrintSC.Opcion).Value = True
    optImpresora(0).Caption = optImpresora(0).Caption & " " & ImpresorapapelA5
    If (oCnfgPrintSC.Opcion > 0) Then
        cboPos.Text = Trim(oCnfgPrintSC.ImpresoraTickets)
        Dim I As Integer
        For I = 0 To cboPos.ListCount - 1
            If cboPos.List(I) = Trim(oCnfgPrintSC.ImpresoraTickets) Then
                cboPos.ListIndex = I
                Exit For
            End If
        Next
