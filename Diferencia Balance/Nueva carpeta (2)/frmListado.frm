...
Private Sub InicializoGrillas()
    ...
    With vsConsulta
        ...
        .Cols = 1: .Rows = 1:
        .FormatString = "<Tipo|<Artículo|>Sistema (Locales)|>|>|>|>|>Se Contó (Balance)|>|>|>|>|>LIFO|>(Ctdo.-Sist)|>|>(Ctdo.-Lifo)|>|"
        ...
        .ColWidth(12) = 700: .ColWidth(13) = 600: .ColWidth(14) = 600: .ColWidth(15) = 600: .ColWidth(16) = 600
        ...
        .Cell(flexcpText, .Rows - 1, 13) = "ST-ST": .Cell(flexcpText, .Rows - 1, 14) = "T-T"
        .Cell(flexcpText, .Rows - 1, 15) = "ST-Lifo": .Cell(flexcpText, .Rows - 1, 16) = "T-Lifo"
        ...
        .Cell(flexcpBackColor, 0, 12, .Rows - 1, 12) = Colores.clCeleste
        .Cell(flexcpBackColor, 0, 13, .Rows - 1, 14) = Colores.Obligatorio
        .Cell(flexcpBackColor, 0, 15, .Rows - 1, 17) = Colores.Blanco
...
Private Sub AccionConsultar()
    ...
    If aQ > 0 Then
        ...
        Do While Not rsAux.EOF
            ...
            With vsConsulta
                ...
                .Cell(flexcpText, .Rows - 1, 12) = Format(rsAux!Q, "#,##0")
            End With
            rsAux.MoveNext
        Loop
        rsAux.Close
    ...
    If aQ > 0 Then
        ...
        cons = "Select ArtID, ArtCodigo, ArtNombre, StLEstado, Sum(StLCantidad) as Q " & _
                   ...
                   " And ArtTipo <> " & paTipoArticuloServicio & _
                   " Group by ArtID, ArtCodigo, ArtNombre, StLEstado" & _
                   " Order by ArtID"
    ...
    If aQ > 0 Then
        ...
        cons = "Select ArtID, ArtCodigo, ArtNombre, BMREstado, Sum(BMRCantidad) as Q" & _
                    ...
                    " Group by ArtID, ArtCodigo, ArtNombre, BMREstado " & _
                    " Order by ArtID"
    ...
    If aQ > 0 Then
        ...
        For I = 2 To vsConsulta.Rows - 1
            pbProgreso.Value = pbProgreso.Value + 1
            With vsConsulta
                .Cell(flexcpText, I, 13) = Format(.Cell(flexcpValue, I, 9) - .Cell(flexcpValue, I, 4), "#,##0") 'ST-ST
                .Cell(flexcpText, I, 14) = Format(.Cell(flexcpValue, I, 11) - .Cell(flexcpValue, I, 6), "#,##0")    'T-T
                
                .Cell(flexcpText, I, 15) = Format(.Cell(flexcpValue, I, 9) - .Cell(flexcpValue, I, 12), "#,##0")
                .Cell(flexcpText, I, 16) = Format(.Cell(flexcpValue, I, 11) - .Cell(flexcpValue, I, 12), "#,##0")
    ...
    With vsConsulta
        ...
        .Subtotal flexSTSum, 0, 11, "#,##0": .Subtotal flexSTSum, 0, 12, "#,##0": .Subtotal flexSTSum, 0, 13, "#,##0": .Subtotal flexSTSum, 0, 14, "#,##0"
        .Subtotal flexSTSum, 0, 15, "#,##0": .Subtotal flexSTSum, 0, 16, "#,##0"
        ...
        .Subtotal flexSTSum, -1, 11, "#,##0": .Subtotal flexSTSum, -1, 12, "#,##0": .Subtotal flexSTSum, -1, 13, "#,##0": .Subtotal flexSTSum, -1, 14, "#,##0"
        .Subtotal flexSTSum, -1, 15, "#,##0": .Subtotal flexSTSum, -1, 16, "#,##0"
        End If
    End With
    Screen.MousePointer = 0
    Exit Sub
