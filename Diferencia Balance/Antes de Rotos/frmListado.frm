...
Private Sub AccionConsultar()
    ...
    With vsConsulta
        ...
        Do While Not RsAux.EOF
            ...
            .Cell(flexcpText, .Rows - 1, 4) = Format(.Cell(flexcpValue, .Rows - 1, 2) - .Cell(flexcpValue, .Rows - 1, 3), "#,##0")
            
            BuscoUltimoCosto RsAux!ArtID, .Cell(flexcpValue, .Rows - 1, 4)
        ...
        Do While Not RsAux.EOF
            ...
            .Cell(flexcpText, .Rows - 1, 6) = Format(.Cell(flexcpValue, .Rows - 1, 4), "#,##0.00")
            .Cell(flexcpText, .Rows - 1, 7) = "1.00"
            RsAux.MoveNext
        Loop
        RsAux.Close
