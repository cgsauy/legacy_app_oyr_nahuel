...
Begin VB.Form GallfrmRecServ 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton bDireccionP 
         Height          =   315
         Left            =   6660
         Picture         =   "Gall frmRecServ.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   1680
         Width           =   315
   ...
   Begin VB.CommandButton bDireccionT 
      Height          =   315
      Left            =   8700
      Picture         =   "Gall frmRecServ.frx":0494
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   780
      Width           =   315
   ...
   Begin VB.Image Image2 
      Height          =   300
      Left            =   6000
      Picture         =   "Gall frmRecServ.frx":061E
      Stretch         =   -1  'True
      Top             =   480
      Width           =   285
   End
   ...
   Begin ComctlLib.ImageList Image1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Gall frmRecServ.frx":0928
            Key             =   "taller"
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Gall frmRecServ.frx":0F72
            Key             =   "retiro"
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Gall frmRecServ.frx":128C
            Key             =   "visita"
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Gall frmRecServ.frx":15A6
            Key             =   "historia"
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Gall frmRecServ.frx":18C0
            Key             =   "servicio"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "GallfrmRecServ"
...
Private Sub cTipoFlete_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyReturn And cTipoFlete.ListIndex > -1 Then Foco cRCamion
End Sub
...
Private Sub cVCamion_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyReturn And cVCamion.ListIndex > -1 Then Foco tVFecha
End Sub
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            Else
                ...
                If IsDate(tRFecha.Tag) Then Foco cRHora
            End If
        Case vbKeyUp
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            Else
                ...
                If IsDate(tVFecha.Tag) Then Foco cVHora
            End If
        Case vbKeyUp
...
ErrCC:
    ...
    Screen.MousePointer = 0
End Sub
Private Sub CargoComboHorario()
On Error GoTo ErrCC
    Screen.MousePointer = 11
    Cons = "Select Codigo, Texto from CodigoTexto Where Tipo = 15 Order by texto"
    CargoCombo Cons, cRHora
    CargoCombo Cons, cVHora
    Screen.MousePointer = 0
    Exit Sub
ErrCC:
    clsGeneral.OcurrioError "Ocurrio un error al cargar los horarios."
    Screen.MousePointer = 0
End Sub
...
Private Sub AccionGrabar()
    ...
    strMsg = "Producto ID = " & vsProducto.Cell(flexcpValue, vsProducto.Row, 0)
...
Private Sub BuscoDatosTipoDeFlete(IDTFlete As Long)
    ...
    If Not RsAux.EOF Then
        If Not IsNull(RsAux!TFlFormaPago) Then
            ...
            End If
        End If
        If IsNull(RsAux!TFlHoraDomingo) And IsNull(RsAux!TFlHoraLunes) And _
            IsNull(RsAux!TFlHoraMartes) And IsNull(RsAux!TFlHoraMiercoles) And _
            IsNull(RsAux!TFlHoraJueves) And IsNull(RsAux!TFlHoraViernes) And _
            IsNull(RsAux!TFlHoraSabado) Then
            
            tRFecha.Text = "": tRFecha.Tag = "": cRHora.ListIndex = -1
        Else
            I = -1
            Do While cRHora.ListIndex = -1
                I = I + 1
                Select Case WeekDay(gFechaServidor + I)
                    Case 1: If Not IsNull(RsAux!TFlHoraDomingo) Then tRFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cRHora, RsAux!TFlHoraDomingo
                    Case 2: If Not IsNull(RsAux!TFlHoraLunes) Then tRFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cRHora, RsAux!TFlHoraLunes
                    Case 3: If Not IsNull(RsAux!TFlHoraMartes) Then tRFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cRHora, RsAux!TFlHoraMartes
                    Case 4: If Not IsNull(RsAux!TFlHoraMiercoles) Then tRFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cRHora, RsAux!TFlHoraMiercoles
                    Case 5: If Not IsNull(RsAux!TFlHoraJueves) Then tRFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cRHora, RsAux!TFlHoraJueves
                    Case 6: If Not IsNull(RsAux!TFlHoraViernes) Then tRFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cRHora, RsAux!TFlHoraViernes
                    Case 7: If Not IsNull(RsAux!TFlHoraSabado) Then tRFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cRHora, RsAux!TFlHoraSabado
                End Select
                If I > 7 Then MsgBox "No se encontro una fecha de retiro para el tipo de flete seleccionado, seleccionela manualmente.", vbInformation, "ATENCIÓN": Exit Do
            Loop
            If IsDate(tRFecha.Tag) Then tRFecha.Text = Format(tRFecha.Tag, "ddd d/mm/yy")
        End If
    End If
...
Private Sub ArmoTipoFleteVisita(IDCamion As Integer)
    ...
    If Not RsAux.EOF Then
        ...
        Else
            I = -1
            Do While cVHora.ListIndex = -1
                I = I + 1
                Select Case WeekDay(gFechaServidor + I)
                    Case 1: If Not IsNull(RsAux!TFlHoraDomingo) Then tVFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cVHora, RsAux!TFlHoraDomingo
                    Case 2: If Not IsNull(RsAux!TFlHoraLunes) Then tVFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cVHora, RsAux!TFlHoraLunes
                    Case 3: If Not IsNull(RsAux!TFlHoraMartes) Then tVFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cVHora, RsAux!TFlHoraMartes
                    Case 4: If Not IsNull(RsAux!TFlHoraMiercoles) Then tVFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cVHora, RsAux!TFlHoraMiercoles
                    Case 5: If Not IsNull(RsAux!TFlHoraJueves) Then tVFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cVHora, RsAux!TFlHoraJueves
                    Case 6: If Not IsNull(RsAux!TFlHoraViernes) Then tVFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cVHora, RsAux!TFlHoraViernes
                    Case 7: If Not IsNull(RsAux!TFlHoraSabado) Then tVFecha.Tag = Format(gFechaServidor + I, FormatoFP): BuscoCodigoEnCombo cVHora, RsAux!TFlHoraSabado
                End Select
                If I > 7 Then tVFecha.Tag = Format(gFechaServidor, FormatoFP): Exit Do
            Loop
            tVFecha.Text = Format(tVFecha.Tag, "ddd d/mm/yy")
        End If
