...
'------------------------------------------------------------------------------------------------------
Public Function ValidoPeriodoFechas(Cadena As String)
...
Public Function RetornoFormatoFechaConsulta(strFecha As String) As String
    ...
    Else
        ...
        If Trim(RetornoFormatoFechaConsulta) = "" Then
            'Entre una fecha y tal otra
            Dim aStr As String
            aStr = ValidoPeriodoFechas(strFecha)
            RetornoFormatoFechaConsulta = "Between " & "'" & Format(Mid(aStr, 1, 10), "mm/dd/yyyy 00:00") & "'" & _
                                                            " And " & _
                                                             "'" & Format(Mid(aStr, 11, 10), "mm/dd/yyyy 23:59") & "'"
        End If
    End If
