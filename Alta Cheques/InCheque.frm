...
Private Sub AccionGrabar()
    ...
    MovimientoDeCaja paMCChequeDiferido, gFechaServidor, mIDDisponibilidad, mMoneda, CCur(tImporte.Text), aTexto, True
...
Private Sub CargoDatosCliente(Codigo As Long)
    ...
    If Not RsAux.EOF Then
        ...
        tCiF.Text = clsGeneral.RetornoFormatoCedula(RsAux!CliCIRuc)
        lClienteF.Tag = Codigo
    End If
    RsAux.Close
    ...
    If aIdCliente <> 0 Then
        ...
        If aTipo = TipoCliente.Persona Then
            ...
            If Not RsAux.EOF Then
                ...
                If Not IsNull(RsAux!CliCIRuc) Then txtCiRuc.Text = clsGeneral.RetornoFormatoCedula(RsAux!CliCIRuc) Else txtCiRuc.Text = FormatoCedula
                lblNombre.Tag = aCodigo
            End If
            RsAux.Close
        End If
