...
Private Sub txtDocumento_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn And Trim(txtDocumento.Text) <> "" Then
        ...
        ElseIf Val(hliCliente.Tag) > 0 Then
            ...
            Cons = "SELECT DocCodigo, DocFModificacion, DocFecha Fecha, dbo.NombreTipoDocumento(100+DocTipo) + ' ' + rTrim(DocSerie)+'-'+Convert(VarChar(10), DocNumero) Documento,  RTRIM(Cast(ArtCodigo as varchar(10))) + ' ' + RTrim(ArtNombre) Artículos" & _
