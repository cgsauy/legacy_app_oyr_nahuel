    ...
    With vsPago
        ...
        If Val(tChNumero.Tag) <> 0 Then
            ...
            cons = "Select Sum(CPaImporte) from ChequePago " & _
                        " Where CPaIdCheque = " & Val(tChNumero.Tag) & _
                        " And CPaIDCompra <> " & tIDCompra.Tag
        ...
        .Cell(flexcpText, .Rows - 1, 5) = Format(tChLibrado.Text, "dd/mm/yy")
        .Cell(flexcpText, .Rows - 1, 6) = Format(tChVence.Text, "dd/mm/yy")
...
Dim RsMov As rdoResultset
    ...
    If sModificar Then
        ...
        Do While Not RsMov.EOF
            ...
            If bDel Then
                If RsMov!MDRIdCheque Then BorroRelacionCheque RsMov!MDRIdCheque, Compra
                RsMov.Delete
            End If
...
Private Sub AccionEliminar()
    ...
    If Not rsAux.EOF Then
        ...
        Do While Not RsRen.EOF
            BorroRelacionCheque RsRen!MDRIdCheque, tIDCompra.Tag
            RsRen.MoveNext
        Loop
        RsRen.Close
...
Private Sub tChNumero_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyReturn Then
        ...
        If Not rsAux.EOF Then
            ...
            If Not IsNull(rsAux!CheVencimiento) Then tChVence.Text = Format(rsAux!CheVencimiento, "dd/mm/yyyy")
        Else
            tChNumero.Tag = 0
...
Dim rs1 As rdoResultset
    ...
    If Not rsAux.EOF Then
        ...
        Do While Not rsAux.EOF
            ...
            If dis_FechaCierre(aValor, CDate(rsAux!MDiFecha)) >= rsAux!MDiFecha Then
...
Private Function ValidoCamposPago() As Boolean
    ...
    If dis_FechaCierre(cDisponibilidad.ItemData(cDisponibilidad.ListIndex), CDate(tFecha.Text)) >= CDate(tFecha.Text) Then
        MsgBox "La disponibilidad " & cDisponibilidad.Text & " al " & tFecha.Text & " está cerrada." & vbCrLf & _
                    "No puede usar ésta disponibilidad para ingresar el pago.", vbInformation, "Disponibilidad Cerrada"
        cDisponibilidad.Text = "": Foco cDisponibilidad
        Exit Function
    End If
...
Private Sub BorroRelacionCheque(mIDCheque As Long, mIDCompra As Long)
