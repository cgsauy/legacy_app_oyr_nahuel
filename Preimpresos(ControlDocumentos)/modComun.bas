...
Public Function RetornoNombreDocumento(Codigo As Integer, Optional Abreviacion As Boolean = False) As String
    ...
    Select Case Codigo
        ...
        Case TipoDocumento.CompraRemito, 6:  If Abreviacion Then aRet = "REM" Else aRet = "Remito"
        ...
        Case TipoDocumento.ResguardoContado, TipoDocumento.ResguardoCredito: If Abreviacion Then aRet = "RESG" Else aRet = "Resguardo"
        'Case TipoDocumento.ResguardoCredito: If Abreviacion Then aRet = "RESCRE" Else aRet = "Resguardo crédito"
