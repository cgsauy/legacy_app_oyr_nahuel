...
Begin VB.Form frmListado 
   Caption         =   "Ingreso de Mercadería Especial"
   ClientHeight    =   6795
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   7395
...
Dim Consulta As Boolean
    ...
    If vsConsulta.Rows > 1 Then
        ...
        vsListado.filename = "Ingreso de Mercadería Especial"
        EncabezadoListado vsListado, "Ingreso de Mercadería Especial al " & Format(gFechaServidor, FormatoFP), False
        ...
        For I = 1 To .Rows - 1
            ...
            If CLng(.Cell(flexcpData, I, 0)) = 0 Then
                ...
                If RsAux.EOF Then
                    ...
                    cBase.RollbackTrans
                    Screen.MousePointer = 0
                    MsgBox "No hay tantos artículos " & Trim(.Cell(flexcpText, I, 2)) & " para dar de baja en el local.", vbCritical, "ATENCIÓN"
                    Exit Sub
                Else
            ...
            If RsAux.EOF Then
                If CLng(.Cell(flexcpData, I, 0)) = 0 Then
                    ...
                    MsgBox "El stock total no coincide con el de los locales, verifique.", vbExclamation, "ATENCIÓN"
                Else
                    RsAux.AddNew
