   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":0554
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":0666
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":0778
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":088A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":099C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":0CB6
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":0DC8
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":10E2
            Key             =   "Alta"
         EndProperty
         BeginProperty ListImage10 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmInMeEsp.frx":13FC
            Key             =   "Baja"
         EndProperty
      EndProperty
   End
...
On Error GoTo ErrBA
    ...
    If KeyAscii = vbKeyReturn And Trim(cArticulo.Text) <> vbNullString Then
        If Not IsNumeric(cArticulo.Text) Then
            BuscoArtXNombre cArticulo.Text
        Else
            BuscoArticuloxCodigo cArticulo.Text
        End If
...
Private Sub cEstadoViejo_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyReturn And cEstadoViejo.ListIndex > -1 Then opAltaBaja(0).SetFocus
End Sub
...
On Error GoTo ErrCL
    ...
    Exit Sub
ErrCL:
    clsGeneral.OcurrioError "Ocurrio un error al cargar los locales.", Err.Description
    Screen.MousePointer = vbDefault
End Sub
...
ErrCE:
    Screen.MousePointer = vbDefault
    clsGeneral.OcurrioError "Ocurrio un error al cargar los Estados."
End Sub
Private Sub BuscoArtXNombre(strArticulo As String)
   
    Dim liAyuda As New clsListadeAyuda
    
    Cons = "Select ArtCodigo, Código = ArtCodigo, Nombre = ArtNombre from Articulo" _
        & " Where ArtNombre LIKE '" & strArticulo & "%'" _
        & " Order by ArtNombre"
    
    cArticulo.Clear
    liAyuda.ActivoListaAyuda Cons, False, miConexion.TextoConexion(logComercio), 4000
    If liAyuda.ValorSeleccionado > 0 Then BuscoArticuloxCodigo liAyuda.ValorSeleccionado
    Set liAyuda = Nothing
...
ErrControl:
    Screen.MousePointer = vbDefault
    clsGeneral.OcurrioError "Ocurrio un error al controlar los datos.", Err.Description
    Exit Sub
...
Private Sub InsertoRenglonLocal(lnCodControl As Long)
    ...
    If itmx.Tag = "Baja" Then
        ...
        MarcoMovimientoStockFisico CLng(tUsuario.Tag), TipoLocal.Deposito, cLocal.ItemData(cLocal.ListIndex), Mid(itmx.Key, 1, InStr(itmx.Key, "V") - 1), CInt(itmx.Text), Mid(itmx.Key, InStr(itmx.Key, "V") + 1, Len(itmx.Key)), -1, TipoDocumento.IngresoMercaderiaEspecial, lnCodControl
    Else
         If RsAux.EOF Then
             RsAux.AddNew
...
Public Sub BuscoArticuloxCodigo(CodArticulo As Long)

    Cons = "Select ArtID, ArtNombre From Articulo" _
        & " Where ArtCodigo = " & CodArticulo
    ...
    If RsAux.EOF Then
        MsgBox "No se encontró un artículo con ese código.", vbExclamation, "ATENCIÓN"
        cArticulo.Text = ""
    Else
