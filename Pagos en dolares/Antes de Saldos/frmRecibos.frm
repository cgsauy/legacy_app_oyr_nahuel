...
Private Sub tNumero_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyReturn Then Foco tIOriginal
End Sub
...
Private Sub InicializoGrillas()
    ...
    With vsLista
        .Rows = 1: .Cols = 1
        .Editable = False
        .FormatString = "<Numero|<Fecha|>Dólares|>Pesos|>Id_Compra|>Paga|>Saldo Actual|>TC"
        .ExtendLastCol = True
        .WordWrap = True
        .ColWidth(0) = 950: .ColWidth(1) = 950: .ColWidth(2) = 1100: .ColWidth(3) = 1500: .ColWidth(5) = 1400
