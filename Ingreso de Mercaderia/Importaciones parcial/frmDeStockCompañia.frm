...
errPago:
    Screen.MousePointer = 0
    msgError.MuestroError "Ocurrió un error al cargar los artículos en la compañía."
End Sub
...
errCom:
    Screen.MousePointer = 0
    msgError.MuestroError "Ocurrió un error al cargar los datos del local compañía."
End Sub
...
errAgregar:
    Screen.MousePointer = 0
    msgError.MuestroError "Ocurrió un error al agregar el artículo."
End Sub
