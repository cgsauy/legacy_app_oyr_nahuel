...
Public Function RetornoEstadoVirtual(Codigo As Integer) As String
    ...
    Select Case Codigo
        Case TipoMovimientoEstado.AEntregar: RetornoEstadoVirtual = "A Enviar"
...
Public Function RetornoNombreDocumento(Codigo As Integer, Optional Abreviacion As Boolean = False) As String
    ...
    Select Case Codigo
        ...
        Case TipoDocumento.ContadoDomicilio: If Abreviacion Then aRet = "VTelef" Else aRet = "Venta Telefónica"
        ...
        Case TipoDocumento.ServicioDomicilio: If Abreviacion Then aRet = "SerDom" Else aRet = "Servicio Domicilio"
        ...
        Case TipoDocumento.Remito: If Abreviacion Then aRet = "REM" Else aRet = "Remito"
        ...
        Case TipoDocumento.ServicioCambioEstado: If Abreviacion Then aRet = "CEM" Else aRet = "Serv. Cambio Estado Mercadería"
