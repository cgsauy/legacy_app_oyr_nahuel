...
On Error GoTo ErrLoad
    ...
    tbExplorer.Buttons("plantilla").Enabled = False
    If m_ArtParam > 0 Then
        BuscoArticuloPorID m_ArtParam, False, False
...
Dim Rs As rdoResultset
    ...
    If tbExplorer.Buttons("plantilla").ButtonMenus.Count > 0 Then tbExplorer.Buttons("plantilla").Enabled = True
    Foco tArticulo
    Screen.MousePointer = 0
    Exit Sub
errConsultar:
