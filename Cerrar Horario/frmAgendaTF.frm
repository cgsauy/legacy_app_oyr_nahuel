   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAgendaTF.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAgendaTF.frx":0554
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAgendaTF.frx":0666
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAgendaTF.frx":0778
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAgendaTF.frx":088A
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub miBotones(bolModificar As Boolean, bolGrabar As Boolean, bolCancelar As Boolean)
    ...
    vsHoraEnvio.Enabled = bolGrabar
    cRangoHora.Enabled = bolGrabar
...
Dim douAux As Double
    ...
    If MsgBox("¿Confirma almacenar la agenda ingresada?", vbQuestion + vbYesNo, "ATENCIÓN") = vbYes Then
        ...
        If tsAgenda.SelectedItem.Index = 1 Then
            db_SavePrincipal douAux, sHE
        ElseIf tsAgenda.SelectedItem.Index = 2 Then
            'Para todas las zonas del grupo armo la agenda.
            If Not db_SaveGrupoZona(douAux, sHE) Then Exit Sub
        Else
            'Zona
            db_SaveAgendaZona Val(tZona.Tag), douAux, sHE
        End If
        AccionCancelar
        Screen.MousePointer = 0
    End If
...
errGrabar:
    ...
    Screen.MousePointer = 0
End Sub
Private Sub db_SavePrincipal(ByVal douAux As Double, ByVal sHE As String)
Dim Cons As String
...
End Sub
Private Function db_SaveGrupoZona(ByVal douAge As Double, ByVal sHE As String) As Boolean
    ...
    With vsSubGrupo
        ...
        For iQ = .FixedRows To .Rows - 1
            If .Cell(flexcpValue, iQ, 0) = iSG Then
                db_SaveAgendaZona .Cell(flexcpData, iQ, 1), douAge, sHE
            End If
        Next
    End With
    cBase.CommitTrans
...
Private Sub db_SaveAgendaZona(ByVal lCodZona As Long, ByVal douAgen As Double, ByVal sHE As String)
Dim Cons As String
Dim rsAux As rdoResultset
    ...
    If douAgen > 0 Then
        ...
        rsAux!FAZFechaAgeHab = Format(Now, "mm/dd/yyyy hh:mm:ss")
    Else
        rsAux!FAZAgenda = Null
...
Dim iSG As Integer
    ...
    Cons = "Select FAZZona, ZonNombre, IsNull(FAZAgenda, 0)  as Agenda, FAZRangoHs as RangoHS, IsNull(FAZHoraEnvio, ' ') as HoraE From FleteAgendaZona, Zona " & _
...
Dim rsAux As rdoResultset
    ...
    douAgenda = 0
    sHoraEnvio = ""
    Cons = "Select IsNull(TFLAgenda, 0), TFLRangoHS, TFLHoraEnvio  From TipoFlete Where TFLCodigo = " & Val(tDescripcion.Tag)
    Set rsAux = cBase.OpenResultset(Cons, rdOpenDynamic, rdConcurValues)
    If Not rsAux.EOF Then
        douAgenda = rsAux(0)
