...
errCargar:
    clsGeneral.OcurrioError "Ocurrió un error al cargar los subrubros.", Err.Description
    Screen.MousePointer = 0
End Sub
...
errModificar:
    clsGeneral.OcurrioError "Ha ocurrido un error al cargar los datos.", Err.Description
    Screen.MousePointer = 0
End Sub
...
Private Sub DeshabilitoIngreso()
    ...
    cRubroC.Enabled = False: cRubroC.BackColor = Inactivo
    cSubRubroC.Enabled = False: cSubRubroC.BackColor = Inactivo
...
Private Sub HabilitoIngreso()
    ...
    cRubroC.Enabled = True: cRubroC.BackColor = Colores.Blanco
    cSubRubroC.Enabled = True: cSubRubroC.BackColor = Colores.Blanco
    cTC.Enabled = True
...
ErrNT:
    clsGeneral.OcurrioError "Ocurrió un error al cargar los números de teléfonos.", Err.Description
    Screen.MousePointer = 0
End Sub
