...
Private Sub cBRubro_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        If cRubro.ListIndex = -1 Then
            MsgBox "Seleccione el rubro para cargar los subrubros.", vbExclamation, "ATENCIÓN"
            Exit Sub
        End If
...
Private Sub tNombre_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyF1 And Not sNuevo And Not sModificar Then
        Cons = "Select DisID 'ID', Disponibilidad = DisNombre, DisCuentaBanco as  'Nº Cuenta', BLoNombre 'Banco', SBaNombre 'Sucursal'" _
...
Private Function ValidoCampos() As Boolean
    ...
    If cBancaria.Value = vbChecked Then
        ...
        If cBSubRubro.ListIndex = -1 Then
            MsgBox "Debe seleccionar el subrubro relacionado a los cheques diferidos a pagar.", vbExclamation, "ATENCIÓN"
