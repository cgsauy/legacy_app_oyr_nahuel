...
Dim RsRub As rdoResultset
    ...
    Do While Not RsAux.EOF
        ...
        With vsConsulta
            ...
            If Not IsNull(RsAux!ComTC) Then
                If Trim(.Cell(flexcpText, .Rows - 1, 6)) = "" Then .Cell(flexcpText, .Rows - 1, 6) = Format(RsAux!ComTC, "#.000") Else .Cell(flexcpText, .Rows - 1, 6) = Format(RsAux!ComTC, "#.000") & " / " & .Cell(flexcpText, .Rows - 1, 6)
            End If
...
Dim rsPro As rdoResultset
                ...
                If aIdEmpresa <> 0 Then
                    With vsConsulta
                        ...
                        If aSubTotalD > 0 Then
                            .Cell(flexcpText, .Rows - 1, 5) = Format(aSubTotalD, FormatoMonedaP)
                            .Cell(flexcpText, .Rows - 1, 6) = Format(aSubTotalP / aSubTotalD, "#.000") & " (" & Format(aSubTotalP, FormatoMonedaP) & " / " & Format(aSubTotalD, FormatoMonedaP) & ")"
                        End If
    ...
    With vsConsulta
        ...
        .Cell(flexcpText, .Rows - 1, 4) = Format(aImporteAcreedores, FormatoMonedaP)
    End With
    '------------------------------------------------------------------------------------------------------------------------------------------------------
