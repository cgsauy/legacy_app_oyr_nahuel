...
Begin VB.Form frmWizGasto 
   ...
   Caption         =   "Sacar Cheque del Depósito"
   ClientHeight    =   5400
   ClientLeft      =   3945
   ClientTop       =   2625
   ClientWidth     =   5955
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Cheque Diferido: se hace un Gasto del tipo ""Salida de Caja"" con el siguiente formato:"
      Height          =   495
      Left            =   60
      TabIndex        =   16
      Top             =   2640
   ...
   Begin VB.Label Label7 
      BackStyle       =   0  'Transparent
      Caption         =   "Desde la Disponibilidad"
      Height          =   255
      Left            =   1260
      TabIndex        =   10
      Top             =   4440
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Cheque Al Día: se hace una Transferencia con el siguiente formato:"
      Height          =   375
      Left            =   60
      TabIndex        =   15
      Top             =   480
...
Private Sub ArmoPantalla()
    ...
    With dGastos(mIdx)
        ...
        BuscoCodigoEnCombo cADDispDesde, .IdDisponibilidadEntrada
        BuscoCodigoEnCombo cADDispA, .IdDisponibilidadSalida
