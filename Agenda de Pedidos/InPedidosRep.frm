...
Private Sub cPago_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Status.SimpleText = "Indique si el pedido está pago."
    
End Sub

Private Sub cProveedor_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)

    Status.SimpleText = "Seleccione el proveedor de artículos del pedido."
...
Private Sub chArribo_GotFocus()
    Status.Panels(4).Text = "Indique si el pedido arribó."
End Sub
...
errorBT:
    Screen.MousePointer = 0
    MsgBox "No se ha podido inicializar la transacción. Reintente la operación." & MapeoError, 48, "ATENCIÓN"
    Exit Sub
End Sub
...
Private Sub tDetalle_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Status.SimpleText = "Detalle de artículos del pedido."
...
Private Sub tFPedido_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Status.SimpleText = "Fecha de realización del pedido."
...
Private Sub CargoEstado()
    ...
    cEstado.AddItem 1
    cEstado.List(0, 1) = "Pedir Cotización"
    cEstado.AddItem 2
    cEstado.List(1, 1) = "Esperando Cotización"
    cEstado.AddItem 3
