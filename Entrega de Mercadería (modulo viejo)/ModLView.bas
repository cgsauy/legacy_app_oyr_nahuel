...
Public Sub SetearLView(Valor As Long, lv As ComctlLib.ListView)
...
Public Function GetCheckState(lngIndex As Long, lv As ComctlLib.ListView) As Boolean
  Dim lngRet As Long
  Dim lngMask As Long
  Dim lvi As LV_ITEM
  Dim plvi As Long
...
Public Sub SetCheckState(lngIndex As Long, fValue As Boolean, lv As ComctlLib.ListView)
...
Public Sub MarcoRedraw(lnValor As Long, lv As ComctlLib.ListView)
    SendMessageLong lv.hwnd, WM_SETREDRAW, lnValor, ByVal 0&
End Sub



Public Sub AutoSizeColumns(lv As ComctlLib.ListView)
