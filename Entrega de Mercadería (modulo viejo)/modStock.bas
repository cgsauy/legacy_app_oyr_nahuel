...
Public Sub MarcoStockVenta(lnUsuario As Long, lnArticulo As Long, cCantARetirar As Currency, cCantAEntregar As Currency, cCantReservado As Currency, iTipoDoc As Integer, lnDocumento As Long, Optional iLocal As Long = -1)
Dim RsStock As rdoResultset
    ...
    If cCantARetirar <> 0 Then
        ...
        Else
            MarcoMovimientoStockEstado lnUsuario, lnArticulo, cCantARetirar, TipoMovimientoEstado.ARetirar, 1, iTipoDoc, lnDocumento, iLocal
        End If
    End If
    ...
    If cCantAEntregar <> 0 Then
        ...
        Else
            MarcoMovimientoStockEstado lnUsuario, lnArticulo, cCantAEntregar, TipoMovimientoEstado.AEntregar, 1, iTipoDoc, lnDocumento, iLocal
        End If
    End If
    ...
    'En Stock Total guardamos el stock virtual.
        ...
        Else
            MarcoMovimientoStockEstado lnUsuario, lnArticulo, cCantReservado, TipoMovimientoEstado.Reserva, 1, iTipoDoc, lnDocumento, iLocal
        End If
    End If
