...
Public Function crMandoAImpresora(NroTrabajo As Integer, CantCopias As Integer)
    ...
    If crMandoAImpresora = 0 Then crMsgErr = "Ocurrió un error al imprimir el reporte. " & vbCr & Err.Description
End Function
...
Dim aDriver As String, aDevice As String, aPuerto As String
    ...
    aModo.dmOrientation = Orientacion
    aModo.dmPaperSize = 1
    'Selecciono esta impresora en el reporte.
    crPESelectPrinter NroTrabajo, Impresora.driverName, Impresora.DeviceName, Impresora.Port, aModo
