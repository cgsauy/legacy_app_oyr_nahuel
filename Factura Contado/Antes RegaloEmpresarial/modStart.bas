...
Private Sub loc_CargoParametroContado()
    Cons = "Select * from Parametro Where ParNombre IN ('eFacturaActiva', 'URLFirmaEFactura', 'catcliDistribuidor', 'TComentarioOperaCH', 'ImporteConCedula', 'ArtsSinCofis', 'AportesACuentaMesesDisponibles', 'efactImporteDatosCliente')"
