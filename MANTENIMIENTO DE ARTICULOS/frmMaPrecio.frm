   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":0554
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":0666
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":0778
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":088A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":099C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":0CB6
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":0DC8
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmMaPrecio.frx":10E2
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub cPlan_GotFocus()
    cPlan.SelStart = 0
    cPlan.SelLength = Len(cPlan.Text)
    Status.Panels(1).Text = "Seleccione el plan para ingresar los precios."
End Sub

Private Sub cPlan_KeyPress(KeyAscii As Integer)

    If KeyAscii = vbKeyReturn Then
        If cPlan.ListIndex <> -1 Then
            LimpioCampos
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        If sNuevo Then  'TRABAJO CON LOS PRECIOS A REGIR-----------------------------------------------------------------
            ...
            If cCuota.ItemData(cCuota.ListIndex) = paTipoCuotaContado Then
                DistribuirCuotas cPlan.ItemData(cPlan.ListIndex), cMoneda.ItemData(cMoneda.ListIndex), CCur(tValor.Text)
            Else
...
On Error GoTo ErrLoad
    ...
    'Cargo los PLANES DE FINANCIACION
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    If sNuevo Or sModificar Then
        If MsgBox("Ud. realizó modificaciones en la ficha y no ha grabado." & Chr(13) _
            & "Desea almacenar la información ingresada.", vbOKCancel + vbExclamation, "ATENCIÓN") = vbOK Then
...
'    Cons = "Select  TCuCodigo, 'Tipo de Cuota' = TCuAbreviacion, Moneda = MonSigno, Precio = HPrPrecio, Vigencia = HPrVigencia" _
           & " From HistoriaPrecio, Moneda, TipoCuota" _
           & " Where HPrMoneda = MonCodigo" _
           & " And HPrTipoCuota = TCuCodigo" _
           & " And HPrArticulo = " & iSeleccionado _
           & "Order by HPrVigencia, HPrArticulo"
...
Cons = "Select  'Plan' = PlaNombre,   'Tipo de Cuota' = TCuAbreviacion, Moneda = MonSigno, Precio = HPrPrecio, Vigencia = HPrVigencia" _
    ...
    LiAyuda.ActivoListaAyudaSQL Cons, miconexion.TextoConexion(logComercio)
    'LiAyuda.ActivoListaAyuda Cons, False, cBase.Connect, 7100
    Set LiAyuda = Nothing
    Exit Sub
...
Private Sub CargoDatosArticuloVigente()
    ...
    Cons = "Select PrecioVigente.*, TCuAbreviacion, TCuCantidad, MonSigno from PrecioVigente, TipoCuota, Moneda" _
            & " Where PViArticulo = " & RsArticulo!ArtID _
            & " And PViTipocuota = TCuCodigo" _
            & " And PViMoneda = MonCodigo" _
            & " Order by TCuOrden"
    Set RsAux = cBase.OpenResultset(Cons, rdOpenDynamic, rdConcurValues)
    
    Do While Not RsAux.EOF
        If cPlan.ListIndex = -1 Then BuscoCodigoEnCombo cPlan, RsAux!PViPlan
...
Private Sub CargoDatosArticuloARegir()
    ...
    'CARGO DATOS DE TABLA Precios Vigentes-------------------
    Cons = "Select PrecioARegir.*, TCuAbreviacion, TCuCantidad, MonSigno from PrecioARegir, TipoCuota, Moneda" _
            & " Where PReArticulo = " & RsArticulo!ArtID _
            & " And PReTipocuota = TCuCodigo" _
            & " And PReMoneda = MonCodigo" _
            & " Order by TCuOrden"
    Set RsAux = cBase.OpenResultset(Cons, rdOpenDynamic, rdConcurValues)
    
    cPlan.ListIndex = -1
    Do While Not RsAux.EOF
        If cPlan.ListIndex = -1 Then BuscoCodigoEnCombo cPlan, RsAux!PRePlan
...
Private Sub CargoCamposBDNuevo()
    ...
    For Each itmx In lPrecio.ListItems
        ...
        RsAux!HPrPlan = cPlan.ItemData(cPlan.ListIndex)
...
Private Sub tVigencia_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        If cPlan.ListIndex <> -1 And IsDate(tVigencia.Text) And cMoneda.ListIndex = -1 Then
