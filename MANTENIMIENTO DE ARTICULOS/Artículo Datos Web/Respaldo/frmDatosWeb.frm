   ...
   Begin MSComctlLib.ImageList imgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":09AC
            Key             =   "salir"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":0CC8
            Key             =   "nuevo"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":0DDC
            Key             =   "codigo"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":1230
            Key             =   "web"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":1B0C
            Key             =   "modificar"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":1C68
            Key             =   "eliminar"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":1D7C
            Key             =   "grabar"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":1E90
            Key             =   "cancelar"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":1FA4
            Key             =   "preview"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":22C0
            Key             =   "edithtml"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":25DC
            Key             =   "glosario"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":28FC
            Key             =   "help"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":2C18
            Key             =   "medidas"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":306C
            Key             =   "genweb"
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatosWeb.frx":3388
            Key             =   "genintra"
         EndProperty
      EndProperty
   End
...
On Error Resume Next
    ...
    End With
    With tTexto
        .Left = 10: tTexto.Top = 10: .Width = picTexto.Width - 80
        .Height = picTexto.Height - 70
    End With
    With tHtml
        .Top = tTexto.Top
        .Left = tTexto.Left
...
Private Sub MiBotones(ByVal bModificar As Boolean, ByVal bEliminar As Boolean, ByVal bGrabar As Boolean)
    ...
    With tooMenu
        ...
        .Buttons("glosario").Enabled = False
        .Buttons("medidas").Enabled = False
    ...
    MnuInsGlosario.Enabled = False
    MnuInsMedidas.Enabled = False
...
On Error GoTo errCDW
    ...
    Cons = "Select ArticuloWebPage.*, PlaWeb.PlaNombre As WebNombre, PlaWeb.PlaFormato As WebFormato, PlaIntra.PlaNombre As IntrNombre, PlaIntra.PlaFormato As IntrFormato" _
        & " From ArticuloWebPage " _
            ...
            & " Left Outer Join Plantilla PlaIntra ON  PlaINtra.PlaCodigo = AWPPlantillaWeb" _
...
Private Sub tTexto_GotFocus()
    If Not tTexto.Locked Then
        tooMenu.Buttons("edithtml").Enabled = True
        MnuInsHTML.Enabled = True
        tooMenu.Buttons("glosario").Enabled = True
        MnuInsGlosario.Enabled = True
        tooMenu.Buttons("medidas").Enabled = True
        MnuInsMedidas.Enabled = True
    End If
End Sub

Private Sub tTexto_LostFocus()
    tooMenu.Buttons("edithtml").Enabled = False
    MnuInsHTML.Enabled = False
    tooMenu.Buttons("glosario").Enabled = False
    MnuInsGlosario.Enabled = False
    tooMenu.Buttons("medidas").Enabled = False
    MnuInsMedidas.Enabled = False
End Sub
...
Private Sub AccionVista()
    Select Case tooMenu.Buttons("vista").Value
        ...
        Case Else
            ...
            End Select
            If tHtml.BrowseMode Then tHtml.SetFocus
    End Select
